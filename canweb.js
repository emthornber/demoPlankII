...
window.setInterval(function(){background()},5000);
// -------------------------------------------
  ...
  if (msg != undefined)
  {
   ...
   for (n = 0; n < msg.length; ++n)
   {
    ...
    if (prefix)
    {
     ...
     {
     case '~': txt += c; break;
     case '_': txt += "<br>"; break; // Newline
     case 'B': txt += "<b>";  break; // Bold On
     case 'b': txt += "</b>"; break; // Bold Off
     case 'I': txt += "<i>";  break; // Italic On
     case 'i': txt += "</i>"; break; // Italic Off
     case 'U': txt += "<u>";  break; // Underline On
     case 'u': txt += "</u>"; break; // Underline Off
     case 'H': txt += "<del>"; break;// Deleted (Strikethrough) On
     case 'h': txt += "</del>";break;// Deleted (Strikethrough) Off
     case 'a': txt += '<font color="aqua">'; break;
     case 'k': txt += '</font>'; break; // Black
     case 'e': txt += '<font color="blue">'; break;
     case 'f': txt += '<font color="fuchsia">'; break;
     case 'g': txt += '<font color="green">'; break;
     case 'd': txt += '<font color="gray">'; break;
     case 'l': txt += '<font color="lime">'; break;
     case 'm': txt += '<font color="maroon">'; break;
     case 'n': txt += '<font color="navy">'; break;
     case 'o': txt += '<font color="olive">'; break;
     case 'p': txt += '<font color="purple">'; break;
     case 'r': txt += '<font color="red">'; break;
     case 's': txt += '<font color="silver">'; break;
     case 't': txt += '<font color="teal">'; break;
     case 'w': txt += '<font color="white">'; break;
     case 'y': txt += '<font color="yellow">'; break;
     }
    }
    else if (c == '~')
    {
   ...
   for (c = 0; c < cols; ++c)
   {
    ...
    if (i < parms.length)
    {
     ...
     if (i < (parms.length-1))  // Not last
      td.onclick = function(){overlayclick(this.id);};
     else
      td.onclick = function(){overlayclick();};
